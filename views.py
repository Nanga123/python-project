...
def Kantara(request):
    conn=mysc.connect (user='root',host='localhost',passwd='sql123inlife',database='bookmyshow')
    cur=conn.cursor()
    qy='select moviename from movies where moviename="kantara"'
    cur.execute(qy)
    data=cur.fetchall()
    qy2='select cast from movies where moviename="kantara"'
    cur.execute(qy2)
    data1=cur.fetchall()
    qy3='select type from movies where moviename="kantara"'
    cur.execute(qy3)
    data2=cur.fetchall()
    qy4='select language from movies where moviename="kantara"'
    cur.execute(qy4)
    data3=cur.fetchall()
    qy5='select rating from movies where moviename="kantara"'
    cur.execute(qy5)
    data4=cur.fetchall()
    data5={
        'movie_name':(data),
    ...
    if request.method=="POST" :
        ...
        pass
    return render(request,'kantara.html',data5)
def Jjk(request):
    conn=mysc.connect (user='root',host='localhost',passwd='sql123inlife',database='bookmyshow')
    cur=conn.cursor()
    qy='select moviename from movies where moviename="jujtsu kaisen 0"'
    cur.execute(qy)
    data=cur.fetchall()
    qy2='select cast from movies where moviename="jujtsu kaisen 0"'
    cur.execute(qy2)
    data1=cur.fetchall()
    qy3='select type from movies where moviename="jujtsu kaisen 0"'
    cur.execute(qy3)
    data2=cur.fetchall()
    qy4='select language from movies where moviename="jujtsu kaisen 0"'
    cur.execute(qy4)
    data3=cur.fetchall()
    qy5='select rating from movies where moviename="jujtsu kaisen 0"'
    cur.execute(qy5)
    data4=cur.fetchall()
    data5={
        'movie_name':(data),
    ...
    if request.method=="POST" :
        ...
        pass
    return render(request,'jjk.html',data5)
